...
const Login = () => {
  ...
  return (
    <div>
      ...
      <img alt='net-logo' src='https://assets.nflxext.com/ffe/siteui/vlv3/9134db96-10d6-4a64-a619-a21da22f8999/a449fabb-05e4-4c8a-b062-b0bec7d03085/IN-en-20240115-trifectadaily-perspective_alpha_website_large.jpg'/>
     ...
     <form onSubmit={(e)=>e.preventDefault()} className='w-3/12 bg-black p-12 m-4 absolute my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-70'>
      ...
      <input ref={pass} className="p-4 my-2  w-full bg-gray-700 rounded-md" type='text' placeholder='password'/>
